...
function mapCssToFont(cssFamily, defaultFont) {
  ...
  if (f.includes("poppins")) return defaultFont.startsWith("Poppins")
    ? defaultFont
    : "PoppinsRegular";
...
app.post("/api/generate-pdf", (req, res) => {
  ...
  doc.registerFont(
    "TimesNew",
    path.join(FONTS_DIR, "TimesNewRoman.ttf")
  );
  doc.registerFont(
    "AlexBrush",
  ...
  // ====== SUBTITLE ======
  const subFontName = mapCssToFont(
    subStyle.fontFamily,
    "PoppinsRegular"
  );
  ...
  // ====== BODY TEXT ======
  const bodyFontName = mapCssToFont(
